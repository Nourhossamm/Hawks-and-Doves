...
public class PlayerAgent implements Steppable {
    ...
    public void step(SimState state) {
        ...
        if(battleRooms.add(newBattle))
        {
            game.writer.write("\n" + newBattle.BattleRoomName + "Created by " + this.getName());
            game.writer.write("\n-----------------------------------------------------");
            game.writer.write("\n" + this.getName() + " has entered " + newBattle.BattleRoomName);
            game.writer.write("\n-----------------------------------------------------");
        }
